	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				outline: "border-border bg-background shadow-sm hover:bg-muted hover:text-foreground dark:hover:bg-input/30 aria-expanded:bg-muted aria-expanded:text-foreground dark:bg-transparent",
